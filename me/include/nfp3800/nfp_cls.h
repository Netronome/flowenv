 ...
 *
 * @file          nfp3800/nfp_cls.h
 * @brief         NFP3800 CLS CSR definitions
 *
 * This files is auto-generated. Do not edit!
 */

#ifndef _NFP3800__NFP_CLS_H_
#define _NFP3800__NFP_CLS_H_
...
#define   NFP_CLS_RINGS_RING_BASE_BASE(x)                    (((x) & 0xff) << 0)
#define   NFP_CLS_RINGS_RING_BASE_BASE_of(x)                 (((x) >> 0) & 0xff)
#define     NFP_CLS_RINGS_RING_BASE_BASE_bf                  0, 7, 0
#define     NFP_CLS_RINGS_RING_BASE_BASE_msk                 (0xff)
...
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_1WORD    (0)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_2WORD    (1)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_4WORD    (2)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_8WORD    (3)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_16WORD   (4)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_32WORD   (5)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_64WORD   (6)
#define     NFP_CLS_AUTOPUSH_WRITE_ALERT_CFG_REGION_RESVD    (7)
...
#define     NFP_CLS_AUTOPUSH_VF_TRANSLATION_VF_ALERT_ALERT12 (1)
#define     NFP_CLS_AUTOPUSH_VF_TRANSLATION_VF_ALERT_ALERT14 (2)
#define     NFP_CLS_AUTOPUSH_VF_TRANSLATION_VF_ALERT_ALERT20 (3)
...
#define   NFP_CLS_HASH_MULT_PREMULT                          (1 << 9)
#define     NFP_CLS_HASH_MULT_PREMULT_bf                     0, 9, 9
#define     NFP_CLS_HASH_MULT_PREMULT_msk                    (0x1)
#define     NFP_CLS_HASH_MULT_PREMULT_bit                    (9)
...
/*
 * Register: ClsHashInitialResidueLow
 *   [31:0]    InitialResidueLow
 *
 * Name(s):
 * <base>.Hash.HashInitialResidueLow
 */
#define NFP_CLS_HASH_INIT_RESIDUE_LO                       0x42000
#define   NFP_CLS_HASH_INIT_RESIDUE_LO_VAL(x)                (((x) & 0xffffffff) << 0)
#define   NFP_CLS_HASH_INIT_RESIDUE_LO_VAL_of(x)             (((x) >> 0) & 0xffffffff)
#define     NFP_CLS_HASH_INIT_RESIDUE_LO_VAL_bf              0, 31, 0
#define     NFP_CLS_HASH_INIT_RESIDUE_LO_VAL_msk             (0xffffffff)
#define     NFP_CLS_HASH_INIT_RESIDUE_LO_VAL_shf             (0)


/*
 * Register: ClsHashInitialResidueHigh
 *   [31:0]    InitialResidueHigh
 *
 * Name(s):
 * <base>.Hash.HashInitialResidueHigh
 */
#define NFP_CLS_HASH_INIT_RESIDUE_HI                       0x42008
#define   NFP_CLS_HASH_INIT_RESIDUE_HI_VAL(x)                (((x) & 0xffffffff) << 0)
#define   NFP_CLS_HASH_INIT_RESIDUE_HI_VAL_of(x)             (((x) >> 0) & 0xffffffff)
#define     NFP_CLS_HASH_INIT_RESIDUE_HI_VAL_bf              0, 31, 0
#define     NFP_CLS_HASH_INIT_RESIDUE_HI_VAL_msk             (0xffffffff)
#define     NFP_CLS_HASH_INIT_RESIDUE_HI_VAL_shf             (0)
...
struct nfp_cls_hash_init_residue_lo {
    union {
        struct {
#           ifdef BIGENDIAN
            unsigned int val:32;
...
struct nfp_cls_hash_init_residue_hi {
    union {
        struct {
#           ifdef BIGENDIAN
            unsigned int val:32;
