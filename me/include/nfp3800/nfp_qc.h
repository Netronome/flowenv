 ...
 *
 * @file          nfp3800/nfp_qc.h
 * @brief         NFP3800 Queue Controller CSR definitions
 *
 * This files is auto-generated. Do not edit!
 */

#ifndef _NFP3800__NFP_QC_H_
#define _NFP3800__NFP_QC_H_
...
#define   NFP_QC_ADD_RPTR_VAL(x)                             (((x) & 0xffff) << 0)
#define   NFP_QC_ADD_RPTR_VAL_of(x)                          (((x) >> 0) & 0xffff)
#define     NFP_QC_ADD_RPTR_VAL_bf                           0, 15, 0
#define     NFP_QC_ADD_RPTR_VAL_msk                          (0xffff)
...
#define   NFP_QC_ADD_WPTR_VAL(x)                             (((x) & 0xffff) << 0)
#define   NFP_QC_ADD_WPTR_VAL_of(x)                          (((x) >> 0) & 0xffff)
#define     NFP_QC_ADD_WPTR_VAL_bf                           0, 15, 0
#define     NFP_QC_ADD_WPTR_VAL_msk                          (0xffff)
...
#define   NFP_QC_STS_LO_EVENT_METHOD                         (1 << 23)
#define     NFP_QC_STS_LO_EVENT_METHOD_BUS                   (0)
#define     NFP_QC_STS_LO_EVENT_METHOD_RING                  (0x800000)
#define     NFP_QC_STS_LO_EVENT_METHOD_bf                    0, 23, 23
#define     NFP_QC_STS_LO_EVENT_METHOD_msk                   (0x1)
#define     NFP_QC_STS_LO_EVENT_METHOD_bit                   (23)
#define   NFP_QC_STS_LO_EVENT_RING(x)                        (((x) & 7) << 20)
#define   NFP_QC_STS_LO_EVENT_RING_of(x)                     (((x) >> 20) & 7)
#define     NFP_QC_STS_LO_EVENT_RING_bf                      0, 22, 20
#define     NFP_QC_STS_LO_EVENT_RING_msk                     (0x7)
#define     NFP_QC_STS_LO_EVENT_RING_shf                     (20)
...
#define   NFP_QC_STS_LO_READPTR(x)                           (((x) & 0xffff) << 0)
#define   NFP_QC_STS_LO_READPTR_of(x)                        (((x) >> 0) & 0xffff)
#define     NFP_QC_STS_LO_READPTR_bf                         0, 15, 0
#define     NFP_QC_STS_LO_READPTR_msk                        (0xffff)
...
#define   NFP_QC_STS_HI_SIZE(x)                              (((x) & 7) << 18)
#define   NFP_QC_STS_HI_SIZE_of(x)                           (((x) >> 18) & 7)
#define     NFP_QC_STS_HI_SIZE_512                           (0)
#define     NFP_QC_STS_HI_SIZE_1K                            (1)
#define     NFP_QC_STS_HI_SIZE_2K                            (2)
#define     NFP_QC_STS_HI_SIZE_4K                            (3)
#define     NFP_QC_STS_HI_SIZE_8K                            (4)
#define     NFP_QC_STS_HI_SIZE_16K                           (5)
#define     NFP_QC_STS_HI_SIZE_32K                           (6)
#define     NFP_QC_STS_HI_SIZE_64K                           (7)
#define     NFP_QC_STS_HI_SIZE_bf                            0, 20, 18
#define     NFP_QC_STS_HI_SIZE_msk                           (0x7)
#define     NFP_QC_STS_HI_SIZE_shf                           (18)
#define   NFP_QC_STS_HI_WRITEPTR(x)                          (((x) & 0xffff) << 0)
#define   NFP_QC_STS_HI_WRITEPTR_of(x)                       (((x) >> 0) & 0xffff)
#define     NFP_QC_STS_HI_WRITEPTR_bf                        0, 15, 0
#define     NFP_QC_STS_HI_WRITEPTR_msk                       (0xffff)
...
#           ifdef BIGENDIAN
            ...
            unsigned int event_method:1;
            unsigned int event_ring:3;
            unsigned int event_type:2;
            unsigned int __reserved_16:2;
            unsigned int readptr:16;
#           else
            unsigned int readptr:16;
            unsigned int __reserved_16:2;
            unsigned int event_type:2;
...
#           ifdef BIGENDIAN
            ...
            unsigned int __reserved_21:1;
            unsigned int size:3;
            unsigned int __reserved_16:2;
            unsigned int writeptr:16;
#           else
            unsigned int writeptr:16;
            unsigned int __reserved_16:2;
            unsigned int size:3;
