 ...
 *
 * @file          nfp3800/nfp_nbi_pc.h
 * @brief         NFP3800 NBI Preclassifier CSR definitions
 */

#ifndef _NFP3800__NFP_NBI_PC_H_
#define _NFP3800__NFP_NBI_PC_H_
 ...
 *   [19]      PreclassifierBufHoppingEnabled
 *   [18]      GFPControlIgn
 *   [17]      GFPBarker
 *   [16]      GFPExtension
 *   [15:12]   PreclassifierBufAllocWaitCount
 *   [11]      PBBEnable
 *   [10]      EnableInitialTag
 *   [9:8]     MaxVlans
 *   [7:4]     InitialTagSize
...
#define   NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFHOPPINGENABLED (1 << 19)
#define     NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFHOPPINGENABLED_bf 0, 19, 19
#define     NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFHOPPINGENABLED_msk (0x1)
#define     NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFHOPPINGENABLED_bit (19)
...
#define   NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFALLOCWAITCOUNT(x) (((x) & 0xf) << 12)
#define   NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFALLOCWAITCOUNT_of(x) (((x) >> 12) & 0xf)
#define     NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFALLOCWAITCOUNT_bf 0, 15, 12
#define     NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFALLOCWAITCOUNT_msk (0xf)
#define     NFP_NBI_PC_CHAR_CFG_PRECLASSIFIERBUFALLOCWAITCOUNT_shf (12)
...
#           ifdef BIGENDIAN
            ...
            unsigned int preclassifierbufhoppingenabled:1;
            unsigned int gfpctlign:1;
            unsigned int gfpbark:1;
            unsigned int gfpext:1;
            unsigned int preclassifierbufallocwaitcount:4;
