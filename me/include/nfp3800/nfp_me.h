 ...
 *
 * @file          nfp3800/nfp_me.h
 * @brief         NFP3800 Microengine CSR definitions
 *
 * This files is auto-generated. Do not edit!
 */

#ifndef _NFP3800__NFP_ME_H_
#define _NFP3800__NFP_ME_H_
 ...
 *   [28]      UstoreNewMode
 *   [27]      UstoreVirtual
 *   [26]      UstorePrefetchRead
 *   [25]      UstoreNextAddress
 *   [15:0]    Uaddr
 *
 * Name(s):
 * <base>.UstorAddr
...
#define   NFP_MECSR_USTORE_ADDRESS_USTORE_NEW_MODE           (1 << 28)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_NEW_MODE_bf      0, 28, 28
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_NEW_MODE_msk     (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_NEW_MODE_bit     (28)
#define   NFP_MECSR_USTORE_ADDRESS_USTORE_VIRTUAL            (1 << 27)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_VIRTUAL_bf       0, 27, 27
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_VIRTUAL_msk      (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_VIRTUAL_bit      (27)
#define   NFP_MECSR_USTORE_ADDRESS_USTORE_PREFETCH_READ      (1 << 26)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_PREFETCH_READ_bf 0, 26, 26
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_PREFETCH_READ_msk (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_PREFETCH_READ_bit (26)
#define   NFP_MECSR_USTORE_ADDRESS_USTORE_NEXT_ADDRESS       (1 << 25)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_NEXT_ADDRESS_bf  0, 25, 25
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_NEXT_ADDRESS_msk (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_USTORE_NEXT_ADDRESS_bit (25)
#define   NFP_MECSR_USTORE_ADDRESS_ADDR(x)                   (((x) & 0xffff) << 0)
#define   NFP_MECSR_USTORE_ADDRESS_ADDR_of(x)                (((x) >> 0) & 0xffff)
#define     NFP_MECSR_USTORE_ADDRESS_ADDR_bf                 0, 15, 0
#define     NFP_MECSR_USTORE_ADDRESS_ADDR_msk                (0xffff)
...
#define   NFP_MECSR_USTORE_ERROR_STATUS_CORRECTABLE          (1 << 30)
#define     NFP_MECSR_USTORE_ERROR_STATUS_CORRECTABLE_bf     0, 30, 30
#define     NFP_MECSR_USTORE_ERROR_STATUS_CORRECTABLE_msk    (0x1)
#define     NFP_MECSR_USTORE_ERROR_STATUS_CORRECTABLE_bit    (30)
...
#define   NFP_MECSR_USTORE_ERROR_STATUS_UADDR(x)             (((x) & 0x7fff) << 0)
#define   NFP_MECSR_USTORE_ERROR_STATUS_UADDR_of(x)          (((x) >> 0) & 0x7fff)
#define     NFP_MECSR_USTORE_ERROR_STATUS_UADDR_bf           0, 14, 0
#define     NFP_MECSR_USTORE_ERROR_STATUS_UADDR_msk          (0x7fff)
 ...
 * <base>.PcBreakpoint0...
 */
#define NFP_MECSR_PC_BREAKPOINT_(x)                        (0x0024 + ((x) * 0x4))
...
#define   MECSR_PC_BREAKPOINT_TCNTL(x)                       (((x) & 0xff) << 16)
#define   MECSR_PC_BREAKPOINT_TCNTL_of(x)                    (((x) >> 16) & 0xff)
#define     MECSR_PC_BREAKPOINT_TCNTL_bf                     0, 23, 16
#define     MECSR_PC_BREAKPOINT_TCNTL_msk                    (0xff)
#define     MECSR_PC_BREAKPOINT_TCNTL_shf                    (16)
#define   MECSR_PC_BREAKPOINT_ADDR(x)                        (((x) & 0x7fff) << 0)
#define   MECSR_PC_BREAKPOINT_ADDR_of(x)                     (((x) >> 0) & 0x7fff)
#define     MECSR_PC_BREAKPOINT_ADDR_bf                      0, 14, 0
#define     MECSR_PC_BREAKPOINT_ADDR_msk                     (0x7fff)
...
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTPC(x)         (((x) & 0xffff) << 16)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTPC_of(x)      (((x) >> 16) & 0xffff)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTPC_bf       0, 31, 16
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTPC_msk      (0xffff)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTPC_shf      (16)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_CTX(x)              (((x) & 7) << 13)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_CTX_of(x)           (((x) >> 13) & 7)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_CTX_bf            0, 15, 13
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_CTX_msk           (0x7)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_CTX_shf           (13)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTBBCNT(x)      (((x) & 3) << 11)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTBBCNT_of(x)   (((x) >> 11) & 3)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTBBCNT_bf    0, 12, 11
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTBBCNT_msk   (0x3)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTBBCNT_shf   (11)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTRUNNING       (1 << 10)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTRUNNING_bf  0, 10, 10
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTRUNNING_msk (0x1)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTRUNNING_bit (10)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTSTWREN        (1 << 9)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTSTWREN_bf   0, 9, 9
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTSTWREN_msk  (0x1)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_BRKPNTSTWREN_bit  (9)
#define   NFP_MECSR_PC_BREAKPOINT_STATUS_INTRPTSTATUS        (1 << 2)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_INTRPTSTATUS_bf   0, 2, 2
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_INTRPTSTATUS_msk  (0x1)
#define     NFP_MECSR_PC_BREAKPOINT_STATUS_INTRPTSTATUS_bit  (2)
...
#define   NFP_MECSR_REGISTER_ERROR_STATUS_REG(x)             (((x) & 0x3ff) << 0)
#define   NFP_MECSR_REGISTER_ERROR_STATUS_REG_of(x)          (((x) >> 0) & 0x3ff)
#define     NFP_MECSR_REGISTER_ERROR_STATUS_REG_bf           0, 9, 0
#define     NFP_MECSR_REGISTER_ERROR_STATUS_REG_msk          (0x3ff)
...
#define   NFP_MECSR_INDIRECT_CTX_STS_CTX_PC(x)               (((x) & 0x7fff) << 0)
#define   NFP_MECSR_INDIRECT_CTX_STS_CTX_PC_of(x)            (((x) >> 0) & 0x7fff)
#define     NFP_MECSR_INDIRECT_CTX_STS_CTX_PC_bf             0, 14, 0
#define     NFP_MECSR_INDIRECT_CTX_STS_CTX_PC_msk            (0x7fff)
 ...
 * <base>.UstorAddr1
 */
#define NFP_MECSR_USTORE_ADDRESS_1                         0x0158
#define   NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEW_MODE         (1 << 28)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEW_MODE_bf    0, 28, 28
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEW_MODE_msk   (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEW_MODE_bit   (28)
#define   NFP_MECSR_USTORE_ADDRESS_1_USTORE_VIRTUAL          (1 << 27)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_VIRTUAL_bf     0, 27, 27
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_VIRTUAL_msk    (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_VIRTUAL_bit    (27)
#define   NFP_MECSR_USTORE_ADDRESS_1_USTORE_PREFETCH_READ    (1 << 26)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_PREFETCH_READ_bf 0, 26, 26
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_PREFETCH_READ_msk (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_PREFETCH_READ_bit (26)
#define   NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEXT_ADDRESS     (1 << 25)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEXT_ADDRESS_bf 0, 25, 25
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEXT_ADDRESS_msk (0x1)
#define     NFP_MECSR_USTORE_ADDRESS_1_USTORE_NEXT_ADDRESS_bit (25)
#define   NFP_MECSR_USTORE_ADDRESS_1_ADDR(x)                 (((x) & 0xffff) << 0)
#define   NFP_MECSR_USTORE_ADDRESS_1_ADDR_of(x)              (((x) >> 0) & 0xffff)
#define     NFP_MECSR_USTORE_ADDRESS_1_ADDR_bf               0, 15, 0
#define     NFP_MECSR_USTORE_ADDRESS_1_ADDR_msk              (0xffff)
#define     NFP_MECSR_USTORE_ADDRESS_1_ADDR_shf              (0)
 ...
 *   [30]      ReqOnCsEccError
 *   [29]      ReqOnLmEccError
 *   [28]      LmEccCorrectDisable
 *   [26]      Interrupt
 *   [24]      ParityEnable
 *   [23]      ForceBadParity
 *   [12]      UstorECCCrctEn
 *   [9:8]     MeScrubRate
 *   [7]       QCS_SCS_Inconsistent
 *   [6]       QuadUstore
 *   [4]       ThrdPrtyAdrMode
 *   [3]       LegacyIndRef
 *   [2]       ShareUstore
...
#define     NFP_MECSR_MISC_CONTROL_REQUEST_ON_CS_ECC_ERROR_NO_REQUEST (0)
...
#define     NFP_MECSR_MISC_CONTROL_REQUEST_ON_LM_ECC_ERROR_NO_REQUEST (0)
...
#define   NFP_MECSR_MISC_CONTROL_LM_ECC_CORRECT_DISABLE      (1 << 28)
#define     NFP_MECSR_MISC_CONTROL_LM_ECC_CORRECT_DISABLE_LM_ECC_CORRECT_ENABLED (0)
#define     NFP_MECSR_MISC_CONTROL_LM_ECC_CORRECT_DISABLE_LM_ECC_CORrECT_DISABLED (0x10000000)
#define     NFP_MECSR_MISC_CONTROL_LM_ECC_CORRECT_DISABLE_bf 0, 28, 28
#define     NFP_MECSR_MISC_CONTROL_LM_ECC_CORRECT_DISABLE_msk (0x1)
#define     NFP_MECSR_MISC_CONTROL_LM_ECC_CORRECT_DISABLE_bit (28)
...
#define   NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE(x)            (((x) & 3) << 8)
#define   NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_of(x)         (((x) >> 8) & 3)
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_DISABLED    (0)
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_ENABLED8    (1)
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_ENABLED8K   (2)
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_ENABLED8M   (3)
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_bf          0, 9, 8
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_msk         (0x3)
#define     NFP_MECSR_MISC_CONTROL_ME_SCRUB_RATE_shf         (8)
#define   NFP_MECSR_MISC_CONTROL_QCS_SCS_INCONSISTENT        (1 << 7)
#define     NFP_MECSR_MISC_CONTROL_QCS_SCS_INCONSISTENT_OK   (0)
#define     NFP_MECSR_MISC_CONTROL_QCS_SCS_INCONSISTENT_BAD  (0x80)
#define     NFP_MECSR_MISC_CONTROL_QCS_SCS_INCONSISTENT_bf   0, 7, 7
#define     NFP_MECSR_MISC_CONTROL_QCS_SCS_INCONSISTENT_msk  (0x1)
#define     NFP_MECSR_MISC_CONTROL_QCS_SCS_INCONSISTENT_bit  (7)
#define   NFP_MECSR_MISC_CONTROL_QUAD_USTORE                 (1 << 6)
#define     NFP_MECSR_MISC_CONTROL_QUAD_USTORE_NOT_QUAD_SHARED (0)
#define     NFP_MECSR_MISC_CONTROL_QUAD_USTORE_QUAD_SHARED   (0x40)
#define     NFP_MECSR_MISC_CONTROL_QUAD_USTORE_bf            0, 6, 6
#define     NFP_MECSR_MISC_CONTROL_QUAD_USTORE_msk           (0x1)
#define     NFP_MECSR_MISC_CONTROL_QUAD_USTORE_bit           (6)
...
#define   MECSR_PC_BREAKPOINT_MASK_MASK(x)                   (((x) & 0x7fff) << 0)
#define   MECSR_PC_BREAKPOINT_MASK_MASK_of(x)                (((x) >> 0) & 0x7fff)
#define     MECSR_PC_BREAKPOINT_MASK_MASK_bf                 0, 14, 0
#define     MECSR_PC_BREAKPOINT_MASK_MASK_msk                (0x7fff)
...
#           ifdef BIGENDIAN
            unsigned int ecs:1;
            unsigned int __reserved_29:2;
            unsigned int ustore_new_mode:1;
            unsigned int ustore_virtual:1;
            unsigned int ustore_prefetch_read:1;
            unsigned int ustore_next_address:1;
            unsigned int __reserved_16:9;
...
#           ifdef BIGENDIAN
            ...
            unsigned int correctable:1;
            unsigned int __reserved_27:3;
            unsigned int syndrome:7;
            unsigned int __reserved_15:5;
...
struct nfp_mecsr_pc_breakpoint_status {
    union {
        struct {
#           ifdef BIGENDIAN
            unsigned int brkpntpc:16;
            unsigned int ctx:3;
            unsigned int brkpntbbcnt:2;
            unsigned int brkpntrunning:1;
            unsigned int brkpntstwren:1;
            unsigned int __reserved_3:6;
            unsigned int intrptstatus:1;
...
#           ifdef BIGENDIAN
            unsigned int rr:1;
            unsigned int __reserved_15:16;
            unsigned int ctx_pc:15;
#           else
            unsigned int ctx_pc:15;
            unsigned int __reserved_15:16;
            unsigned int rr:1;
...
struct nfp_mecsr_ustore_address_1 {
    union {
        struct {
#           ifdef BIGENDIAN
...
#           ifdef BIGENDIAN
            ...
            unsigned int lm_ecc_correct_disable:1;
            unsigned int __reserved_27:1;
            ...
            unsigned int me_scrub_rate:2;
            unsigned int qcs_scs_inconsistent:1;
            unsigned int quad_ustore:1;
            unsigned int __reserved_5:1;
