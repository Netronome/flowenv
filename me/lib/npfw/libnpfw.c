...
/*
 * The following files implement all the functionality in <npfw/*.h>.
 * They are not protected by header guards and should not be included
 * elsewhere.
 */
#include "_c/catamaran_app_utils.c"
#include "_c/catamaran_utils.c"
#include "_c/nbi_cpp.c"
#include "_c/nbi_pc_mem.c"
